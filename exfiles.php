...
<script>
    // Mock existing files (Example: paths of existing files)
    const existingFiles = [
            { name: "photo-1533450718592-29d45635f0a9.jpg", size: 729088, path: "uploads/photo-1533450718592-29d45635f0a9.jpg" },
            { name: "website.jpg", size: 123904, path: "uploads/website.jpg" }
        ];
